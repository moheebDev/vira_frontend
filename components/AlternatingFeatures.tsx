...
const features = [
  {
    ...
    platforms: ["Instagram Audit", "TikTok Analysis", "FB Growth"]
  },
  {
    id: "features",
    title: "AI-Powered Content Generation",
    subtitle: "Stop staring at a blank screen.",
    description: "Generate viral captions, attention-grabbing hooks, and high-conversion video scripts in seconds. Our models are trained on the latest trending content across all major social networks like TikTok and Reels.",
    ...
    platforms: ["Viral Hooks", "AI Scripts", "Captions"]
  },
  {
    id: "hashtags",
              ...
              <div className="lg:w-1/2 w-full">
                <div className="relative group">
                  ...
                  <img 
                    src={feature.image} 
                    alt={feature.title} 
                    className="relative z-10 w-full rounded-[3rem] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.15)] object-cover aspect-square lg:aspect-[4/3] border border-gray-100"
                  />
